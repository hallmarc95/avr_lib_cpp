...
#ifdef __HAVE_TIMER0_8BITS__
struct TIMER0_8Bits final {
...
struct TIMER1_16Bits final {
    ...
    static constexpr auto& _FOC_R = _CRC;
...
public:
    ...
    void SetOperationMode(TimerOperationModeExtended const InMode) const {
        static_assert(std::Is_Same<typename M::WGM_Type, TimerOperationModeExtended>::Value, "Invalid type for operation of this module");
    ...
    void SetOperationMode(TimerOperationMode const InMode) const {
        static_assert(std::Is_Same<typename M::WGM_Type, TimerOperationMode>::Value, "Invalid type for operation of this module");
